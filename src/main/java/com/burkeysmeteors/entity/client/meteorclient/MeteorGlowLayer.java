...
public class MeteorGlowLayer<T extends StandardMeteorEntity> extends EyesLayer<T, MeteorModel<T>> {
    private static final RenderType METEOR_GLOW = RenderType.eyes(ResourceLocation.fromNamespaceAndPath(Burkeysmeteormod.MODID,"textures/entity/meteor/meteor.png"));
